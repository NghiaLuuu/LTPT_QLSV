...
public class SubjectServiceImpl implements SubjectService {
    ...
    @Override
    @Transactional
    @CacheEvict(value = "subjects:all", allEntries = true)
    public Subject createSubject(SubjectRequest request) {
        ...
        localCacheClient.evict("subjects:id:" + saved.getId());
    ...
    public Subject updateSubject(Long id, SubjectRequest request) {
        ...
        // Thêm sinh viên vào môn học nếu có
        if (request.getStudentIds() != null && !request.getStudentIds().isEmpty()) {
            ...
            for (Long studentId : request.getStudentIds()) {
                ...
                if (!alreadyEnrolled) {
                    ...
                    // Gửi WebSocket thông báo cho sinh viên
        ...
        messagingTemplate.convertAndSend("/topic/subjects/updates",
                "Môn học " + updatedSubject.getName() + " đã được cập nhật");
    ...
    public void deleteSubject(Long id) {
        ...
        // 🔥 Realtime thông báo xóa môn học
        messagingTemplate.convertAndSend("/topic/subjects/updates",
                "Môn học " + subject.getName() + " đã bị xóa");
    }
