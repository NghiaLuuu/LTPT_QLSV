...
public class EnrollmentServiceImpl implements EnrollmentService {
    ...
    @Override
    @Transactional
    @CacheEvict(value = "enrollments:all", allEntries = true)
    public Enrollment createEnrollment(EnrollmentRequest request) {
        ...
        if (request.getLecturerId() != null) {
            ...
            enrollment.setLecturer(lecturer);
        }

        Enrollment savedEnrollment = enrollmentRepository.save(enrollment);

        evictEnrollmentCache(student);
        broadcastEnrollmentUpdate(student);

        return savedEnrollment;
    }
    // Tách function để tái sử dụng
    private void evictEnrollmentCache(Student student) {
        localCacheClient.evict("enrollments:all");
        localCacheClient.evict("enrollments:student:" + student.getId());
        localCacheClient.evict("student:dashboard:" + student.getStudentCode());
    }

    private void broadcastEnrollmentUpdate(Student student) {
        ...
        messagingTemplate.convertAndSend("/topic/student/" + student.getStudentCode() + "/enrollments", dashboardData);
    }
    ...
    @Override
    @Cacheable(value = "enrollments:all")
