...
public class LecturerPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        // Table
        String[] columns = {"ID", "Mã GV", "Họ tên", "Email", "Điện thoại", "Khoa", "Học vị", "Giới tính"};
        ...
        lecturerTable.setSelectionBackground(new Color(41, 128, 185, 50));
    ...
    private void showEditDialog() {
        ...
        Long lecturerId = (Long) tableModel.getValueAt(selectedRow, 0);
