...
/**
 * Màn hình đăng nhập dành cho sinh viên
 */
public class StudentLoginFrame extends JFrame {
    ...
    public StudentLoginFrame() {
        initComponents();
        setTitle("Đăng Nhập Sinh Viên - Hệ Thống Quản Lý Sinh Viên");
        setSize(500, 600);
    ...
    private void initComponents() {
        ...
        JPanel mainPanel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                int w = getWidth();
                int h = getHeight();
                // Use different gradient for student login
        ...
        // Title
        lblTitle = new JLabel("ĐĂNG NHẬP SINH VIÊN");
        ...
        // Username field
        JLabel lblUsername = new JLabel("Mã sinh viên");
            ...
            protected void done() {
                try {
                    ...
                    if (!"STUDENT".equals(response.getRole())) {
                        showError("Tài khoản này không phải là sinh viên!");
