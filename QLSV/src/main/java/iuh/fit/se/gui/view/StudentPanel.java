...
public class StudentPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        txtSearch = new ModernTextField(10);
        txtSearch.setPreferredSize(new Dimension(200, AppTheme.INPUT_HEIGHT));
        ...
        // Table
        String[] columns = {"STT", "ID", "Mã SV", "Họ tên", "Giới tính", "Ngày sinh", "Email", "Lớp"};
        ...
        studentTable.getTableHeader().setBackground(AppTheme.PRIMARY_DARK);
        studentTable.getTableHeader().setForeground(Color.BLACK);
        studentTable.setSelectionBackground(new Color(200, 18, 18, 255));
    ...
    private void performSearch() {
        ...
        int viewRow = studentTable.convertRowIndexToView(foundModelRow);
        studentTable.setRowSelectionInterval(viewRow, viewRow);
        Rectangle rect = studentTable.getCellRect(viewRow, 0, true);
        studentTable.scrollRectToVisible(rect);
    }
    ...
    private void loadStudents() {
        ...
        SwingWorker<List<StudentResponse>, Void> worker = new SwingWorker<>() {
            ...
            protected List<StudentResponse> doInBackground() throws Exception {
                String json = ApiClient.get("/students"); // Lấy tất cả sinh viên
                System.out.println(json);

                return ApiClient.getObjectMapper()
                        .readValue(json, new TypeReference<List<StudentResponse>>() {});
            }
                ...
                try {
                    ...
                    for (StudentResponse student : students) {
                        tableModel.addRow(new Object[]{
                                ...
                                student.getFacultyName() != null ? student.getFacultyName() : "Chưa có khoa"
                        });
                    }
                } catch (Exception ex) {
    ...
    private void showEditDialog() {
        ...
        Long studentId = (Long) tableModel.getValueAt(selectedRow, 1);
