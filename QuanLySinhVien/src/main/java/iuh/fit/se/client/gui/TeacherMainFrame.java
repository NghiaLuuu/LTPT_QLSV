...
import iuh.fit.se.client.gui.panels.teacher.TeacherClassListPanel;
import iuh.fit.se.client.gui.panels.teacher.TeacherGradeEntryPanel;
import iuh.fit.se.client.gui.panels.teacher.TeacherStatisticsPanel;
...
public class TeacherMainFrame extends JFrame {
    ...
    // Panels
    private TeacherClassListPanel classListPanel;
    private TeacherGradeEntryPanel gradeEntryPanel;
    private TeacherStatisticsPanel statisticsPanel;

    public TeacherMainFrame(AuthResponseDTO authResponse, NetworkClient networkClient) {
    ...
    private void initComponents() {
        setTitle("🎓 Hệ thống Quản lý Đào tạo - Giảng viên: " + authResponse.getUsername());
        setSize(1400, 800);
    ...
    private void setupLayout() {
        ...
        // Create panels for teacher
        classListPanel = new TeacherClassListPanel(networkClient, authResponse);
        gradeEntryPanel = new TeacherGradeEntryPanel(networkClient, authResponse);
        statisticsPanel = new TeacherStatisticsPanel(networkClient, authResponse);

        tabbedPane.addTab("  📚 Lớp học phần của tôi  ", classListPanel);
    ...
    private JPanel createHeaderPanel() {
        ...
        JLabel titleLabel = new JLabel("GIẢNG VIÊN");
        titleLabel.setFont(new Font("Segoe UI", Font.BOLD, 20));
        titleLabel.setForeground(Color.WHITE);

        JLabel subtitleLabel = new JLabel("Quản lý giảng dạy và nhập điểm");
        ...
        JLabel roleLabel = new JLabel("• Mã GV: " + authResponse.getMaGV());
    ...
    private void showAbout() {
        ...
        JLabel titleLabel = new JLabel("GIẢNG VIÊN - HỆ THỐNG QUẢN LÝ ĐÀO TẠO");
